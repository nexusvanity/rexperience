...
! function(t) {
	...
	V.cleanData = (n = V.cleanData, function(t) {
		...
		for (var e, i, s = c.call(arguments, 1), n = 0, o = s.length; n < o; n++)
			for (e in s[n]) i = s[n][e], E.call(s[n], e) && void 0 !== i && (V.isPlainObject(i) ? t[e] = V.isPlainObject(t[e]) ? V.widget.extend({}, t[e], i) : V.widget.extend({}, i) : t[e] = i);
		return t
	...
	}, V.expr.pseudos || (V.expr.pseudos = V.expr[":"]), V.uniqueSort || (V.uniqueSort = V.unique), V.escapeSelector || (F = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, L = function(t, e) {
	...
	V.widget("ui.droppable", {
		...
		switch (i) {
			...
			case "pointer":
				return Y(s.pageY, h, e.proportions().height) && Y(s.pageX, l, e.proportions().width);
			case "touch":
	...
	V.widget("ui.controlgroup", {
		...
		_resolveClassesValues: function(i, s) {
			...
			return V.each(i, function(t) {
				var e = s.options.classes[t] || "",
					e = String.prototype.trim.call(e.replace(j, ""));
	...
	}), V.fn.button = (B = V.fn.button, function(i) {
		var t = "string" == typeof i,
		...
		return t ? this.length || "instance" !== i ? this.each(function() {
			...
			var t = V(this).attr("type"),
				...
				e = V.data(this, "ui-" + t);
			e ? (e.option(i || {}), e._init && e._init()) : "button" == t ? B.call(V(this), i) : V(this).checkboxradio(V.extend({
				icon: !1
			}, i))
		})), n
	...
	function q() {
		this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = {
			...
			autoSize: !1,
			disabled: !1
		}, V.extend(this._defaults, this.regional[""]), this.regional.en = V.extend(!0, {}, this.regional[""]), this.regional["en-US"] = V.extend(!0, {}, this.regional.en), this.dpDiv = K(V("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
	}
	...
	V.extend(V.ui, {
		...
		_newInst: function(t, e) {
			return {
				...
				drawYear: 0,
				inline: e,
				dpDiv: e ? K(V("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv
			}
		},
		...
		_generateHTML: function(t) {
			var e, i, s, n, o, E, W, F, L, a, r, R, l, h, c, u, d, p, f, g, m, _, Y, v, b, B, y, j, q, w, x, k, C = new Date,
				...
				N = t.drawYear;
			if (O < 0 && (O += 12, N--), A)
				for (e = this._daylightSavingAdjust(new Date(A.getFullYear(), A.getMonth() - P[0] * P[1] + 1, A.getDate())), e = z && e < z ? z : e; this._daylightSavingAdjust(new Date(N, O, 1)) > e;) --O < 0 && (O = 11, N--);
	...
	}, V.datepicker = new q, V.datepicker.initialized = !1, V.datepicker.uuid = (new Date).getTime(), V.datepicker.version = "1.13.3";
	V.datepicker, V.widget("ui.dialog", {
		version: "1.13.3",
		options: {
			appendTo: "body",
			autoOpen: !0,
	...
	function y(t) {
		return null == t ? t + "" : "object" == typeof t ? m[X.call(t)] || "object" : typeof t
	}
	...
	function Z(s) {
		var n = _(),
			o = n._rgba = [];
		return s = s.toLowerCase(), b(G, function(t, e) {
			var i = e.re.exec(s),
				i = i && e.parse(i),
				e = e.space || "rgba";
	...
	t.style.cssText = "background-color:rgba(1,1,1,.5)", J.rgba = -1 < t.style.backgroundColor.indexOf("rgba"), b(v, function(t, e) {
		...
		parse: function(n, t, e, i) {
			...
			var o = this,
				s = y(n),
				a = this._rgba = [];
			return void 0 !== t && (n = [n, t, e, i], s = "array"), "string" === s ? this.parse(Z(n) || M._default) : "array" === s ? (b(v.rgba.props, function(t, e) {
				a[e.idx] = w(n[e.idx], e)
		...
		transition: function(t, a) {
			...
			return b(e.props, function(t, e) {
				var i = e.idx,
					...
					n = h[i],
					o = Q[e.type] || {};
				null !== n && (null === s ? l[i] = n : (o.mod && (n - s > o.mod / 2 ? s += o.mod : s - n > o.mod / 2 && (s -= o.mod)), l[i] = w((n - s) * a + s, e)))
			}), this[t](l)
		},
		blend: function(t) {
			var e, i, s;
	...
	})).parse.prototype = _.fn, v.hsla.to = function(t) {
		var e, i, s, n, o, a, r, l;
		...
		var e, i, s;
		return null == t[0] || null == t[1] || null == t[2] ? [null, null, null, t[3]] : (e = t[0] / 360, s = t[1], i = t[2], t = t[3], s = 2 * i - (i = i <= .5 ? i * (1 + s) : i + s - i * s), [Math.round(255 * T(s, i, e + 1 / 3)), Math.round(255 * T(s, i, e)), Math.round(255 * T(s, i, e - 1 / 3)), t])
	}, b(v, function(r, t) {
		var e = t.props,
			o = t.cache,
			a = t.to,
		...
		_.fn[r] = function(t) {
			...
			_.fn[o] || (_.fn[o] = function(t) {
				var e = y(t),
					...
					s = this[i](),
					n = s[a.idx];
				return "undefined" === e ? n : ("function" === e && (e = y(t = t.call(this, n))), null == t && a.empty ? this : ("string" === e && (e = $.exec(t)) && (t = n + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), s[a.idx] = t, this[i](s)))
			})
		})
	}), (_.hook = function(t) {
		t = t.split(" ");
		b(t, function(t, o) {
			g.cssHooks[o] = {
				set: function(t, e) {
					var i, s, n = "";
					if ("transparent" !== e && ("string" !== y(e) || (i = Z(e)))) {
						if (e = _(i || e), !J.rgba && 1 !== e._rgba[3]) {
				...
				t.colorInit || (t.start = _(t.elem, o), t.end = _(t.end), t.colorInit = !0), g.cssHooks[o].set(t.elem, t.start.transition(t.end, t.pos))
			}
		})
	...
	var tt, et, it, st, nt, ot, at, rt, lt, P, M = g.Color.names = {
			aqua: "#00ffff",
			black: "#000000",
			blue: "#0000ff",
			fuchsia: "#ff00ff",
	...
	V.effects = {
		...
		effect: function() {
			function t(t) {
				...
				e.data(z, !0), l.push(i), o && ("show" === i || i === o && "hide" === i) && e.show(), o && "none" === i || V.effects.saveStyle(e), "function" == typeof t && t()
			}
			...
			function h(t) {
				...
				s.mode = l.shift(), !1 === V.uiBackCompat || o ? "none" === s.mode ? (e[r](), i()) : n.call(e[0], s, function() {
					e.removeData(z), V.effects.cleanUp(e), "hide" === s.mode && e.hide(), i()
				}) : (e.is(":hidden") ? "hide" === r : "show" === r) ? (e[r](), i()) : n.call(e[0], s, i)
			}
		},
		show: (lt = V.fn.show, function(t) {
			return O(t) ? lt.apply(this, arguments) : ((t = A.apply(this, arguments)).mode = "show", this.effect.call(this, t))
		}),
		hide: (rt = V.fn.hide, function(t) {
			return O(t) ? rt.apply(this, arguments) : ((t = A.apply(this, arguments)).mode = "hide", this.effect.call(this, t))
		}),
		toggle: (at = V.fn.toggle, function(t) {
			return O(t) || "boolean" == typeof t ? at.apply(this, arguments) : ((t = A.apply(this, arguments)).mode = "toggle", this.effect.call(this, t))
		}),
		cssUnit: function(t) {
			var i = this.css(t),
				s = [];
